...
<td align="center" width="25%"><a href="medical-imaging/gma-video-pipeline/"><img src="docs/gallery/gma-roll-gate.png" alt="Dark stat card: 91% of the recording was usable; stick-figure poses over a green validity timeline, with the mid-roll figure and its excluded segment in red"></a><br><sub><b>Infant-movement video pipeline</b><br>error handling for phone-video movement screening: a mid-recording roll is detected and excluded</sub></td>
