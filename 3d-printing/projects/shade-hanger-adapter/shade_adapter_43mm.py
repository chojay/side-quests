...
VERSION: Y reduced by 2mm (43mm instead of 45mm)
"""
import numpy as np
...
# === PARAMETERS ===
PLATE_X = 30.0  # mm
PLATE_Y = 43.0  # mm (reduced from 45mm by 2mm)
PLATE_Z = 3.0   # mm (thickness)
...
# === GENERATE GEOMETRY ===
print("Generating shade adapter geometry (43mm version)...")
adapter = create_plate_with_oval_holes()

# === EXPORT STL ===
stl_file = "shade_adapter_43mm.stl"
adapter.export(stl_file)
print(f"✓ Exported: shade_adapter_43mm.stl")
...
<html><head><title>Shade Adapter 43mm - 3D Viewer</title>
<style>
...
html_file = "shade_adapter_43mm.html"
with open(html_file, 'w') as f:
    f.write(html_content)
print(f"✓ Interactive viewer: shade_adapter_43mm.html")
