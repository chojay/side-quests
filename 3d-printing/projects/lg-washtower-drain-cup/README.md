...
Draining the pump filter on an [LG WashTower](https://www.lg.com/us/washtowers) dumps water from a round filter cap ~110 mm off the floor, and the gap under it fits no container I own. This is a two-part catch system: a cylindrical cup with an angled socket, and a thin spout tongue that slips into the gap under the filter opening and guides water into the cup. The pattern follows the proven "drain bowl" class of models for round LG filter caps (cf. Printables model 1536585); the geometry here is original.
