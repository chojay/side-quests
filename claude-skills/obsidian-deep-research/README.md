# obsidian-deep-research (a Claude Code skill)

Multi-phase research orchestration that writes findings into an Obsidian vault as interconnected notes with source-credibility scoring.
